    ...
    <AuthCard
      ...
      footer={
        <>
          ...
          <Link href={`/sign-up${plan ? `?plan=${plan}` : ""}`} className="font-medium text-primary hover:underline">
            Sign up
          </Link>
        </>
      }
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="space-y-2">
            <div className="flex items-center justify-between">
              ...
              <Link href="/reset-password" className="text-sm font-medium text-primary hover:underline">Forgot password?</Link>
            </div>
            <input
              id="password"
              type="password"
