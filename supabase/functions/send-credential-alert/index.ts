...
<tr><td style="background:#FFFFFF;border:1px solid rgba(0,0,0,0.12);border-radius:8px;padding:32px 24px;">
<p style="color:rgba(0,0,0,0.55);font-size:13px;margin:0 0 8px;">COMPLIANCE ALERT</p>
<h2 style="color:#000000;font-size:20px;font-weight:600;margin:0 0 16px;">${staffName}'s ${credentialType} expires in ${daysBeforeExpiration} days</h2>
...
<p style="color:rgba(0,0,0,0.55);font-size:13px;margin:0 0 8px;">Expiration date: <strong>${expirationDate}</strong></p>
<p style="color:rgba(0,0,0,0.55);font-size:13px;margin:0;">${urgency}</p>
</td></tr></table>
<p style="color:#000000;font-size:14px;line-height:1.5;margin:0 0 20px;">Visit your state board website to renew this credential before the expiration date. Upload the new certificate in the dashboard once complete.</p>
<a href="${htmlEscape(dashboardLink)}" style="display:inline-block;background:#6E97A7;color:#FFFFFF;font-size:14px;font-weight:500;text-decoration:none;padding:10px 20px;border-radius:6px;">View in dashboard</a>
...
<body style="font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,sans-serif;background-color:#FFFFFF;padding:24px;margin:0;">
<table width="100%" cellpadding="0" cellspacing="0" style="max-width:480px;margin:0 auto;">
<tr><td style="background:#FFFFFF;border:1px solid rgba(0,0,0,0.12);border-top:4px solid #B8443A;border-radius:0 0 8px 8px;padding:32px 24px;">
<p style="color:#B8443A;font-size:13px;font-weight:600;margin:0 0 8px;">ESCALATION — CREDENTIAL EXPIRED</p>
<h2 style="color:#000000;font-size:20px;font-weight:600;margin:0 0 16px;">${staffName}'s ${credentialType} has EXPIRED</h2>
<table width="100%" cellpadding="0" cellspacing="0" style="background:#F0F4F5;border:1px solid #B8443A;border-radius:6px;padding:16px;margin:0 0 20px;">
<tr><td>
<p style="color:#000000;font-size:14px;margin:0 0 4px;"><strong>${credentialLabel}</strong></p>
<p style="color:rgba(0,0,0,0.55);font-size:13px;margin:0 0 8px;">Expired: <strong>${expirationDate}</strong></p>
...
<p style="color:#000000;font-size:14px;line-height:1.5;margin:0 0 20px;">An expired credential means the staff member cannot legally perform procedures that require it. This is the #1 cause of board investigations for med spas.</p>
<a href="${htmlEscape(dashboardLink)}" style="display:inline-block;background:#6E97A7;color:#FFFFFF;font-size:14px;font-weight:500;text-decoration:none;padding:10px 20px;border-radius:6px;">View in dashboard</a>
<hr style="border:none;border-top:1px solid rgba(0,0,0,0.12);margin:24px 0 16px;">
